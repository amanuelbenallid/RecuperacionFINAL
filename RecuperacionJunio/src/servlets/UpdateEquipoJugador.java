...
/**
 * Servlet implementation class UpdateEquipoJugador
 */
@WebServlet("/UpdateEquipoJugador")
public class UpdateEquipoJugador extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateEquipoJugador() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		JugadoresDAO.updatejugador(jugador_id, equipo);
